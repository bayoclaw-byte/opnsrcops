...
class BleakClientWinRT(BaseBleakClient):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._services_changed_token: <REDACTED>
        self._session_status_changed_token: <REDACTED>
        self._max_pdu_size_changed_token: <REDACTED>
    ...
    async def connect(self, pair: bool, **kwargs: Any) -> None:
        ...
        def handle_disconnect() -> None:
            if self._requester:
                if self._services_changed_token:<REDACTED>
            ...
            if self._session:
                if self._session_status_changed_token:<REDACTED>
                    self._session.remove_session_status_changed(
                        self._session_status_changed_token
                    )
                    self._session_status_changed_token = <REDACTED>

                if self._max_pdu_size_changed_token:<REDACTED>
    ...
    async def disconnect(self) -> None:
        ...
        for handle, event_handler_token <REDACTED>
        ...
        if self._session and self._session_status_changed_token:<REDACTED>
            self._session.remove_session_status_changed(
                self._session_status_changed_token
            )
            self._session_status_changed_token = <REDACTED>
    ...
    async def pair(
        ...
        **kwargs: Any,
        ...
        pairing_requested_token = <REDACTED>
