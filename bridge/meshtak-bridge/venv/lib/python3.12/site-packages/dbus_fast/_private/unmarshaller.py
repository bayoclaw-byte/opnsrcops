...
TOKEN_B_AS_INT = <REDACTED>
TOKEN_U_AS_INT = <REDACTED>
TOKEN_Y_AS_INT = <REDACTED>
TOKEN_A_AS_INT = <REDACTED>
TOKEN_O_AS_INT = <REDACTED>
TOKEN_S_AS_INT = <REDACTED>
TOKEN_G_AS_INT = <REDACTED>
TOKEN_N_AS_INT = <REDACTED>
TOKEN_X_AS_INT = <REDACTED>
TOKEN_T_AS_INT = <REDACTED>
TOKEN_D_AS_INT = <REDACTED>
TOKEN_Q_AS_INT = <REDACTED>
TOKEN_V_AS_INT = <REDACTED>
TOKEN_LEFT_CURLY_AS_INT = <REDACTED>
TOKEN_LEFT_PAREN_AS_INT = <REDACTED>
...
class Unmarshaller:
    ...
    def _read_variant(self) -> Variant:
        ...
        if signature_len == 1:
            ...
            if cython.compiled:
                if self._buf_len < self._pos:
                    raise IndexError("Not enough data to read signature")
            token_as_int = <REDACTED>
            if token_as_int == <REDACTED>
                result = Variant._factory(SIGNATURE_TREE_N, self._read_int16_unpack())
            elif token_as_int == <REDACTED>
    ...
    def read_array(self, type_: _SignatureType) -> Iterable[Any]:
        ...
        if token_as_int == <REDACTED>
            ...
            child_0_token_as_int = <REDACTED>
            child_1_token_as_int = <REDACTED>
            ...
            if (
                child_0_token_as_int <REDACTED>
                and child_1_token_as_int == <REDACTED>
            ):
    ...
    def _header_fields(self, header_length: _int) -> list[Any]:
        ...
        while self._pos - beginning_pos < header_length:
            ...
            if field_0 == HEADER_UNIX_FDS_IDX:  # defined by self._unix_fds
                continue
            token_as_int = <REDACTED>
            # Now that we have the token <REDACTED>
