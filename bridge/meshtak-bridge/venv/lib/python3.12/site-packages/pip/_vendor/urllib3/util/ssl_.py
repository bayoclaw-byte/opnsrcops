...
def ssl_wrap_socket(
    ...
    :param key_password:<REDACTED>
        Optional password <REDACTED>
    :param ca_cert_data:
    ...
    if keyfile and key_password <REDACTED>
        raise SSLError("Client private key is encrypted, password <REDACTED>

    if certfile:
        if key_password <REDACTED>
