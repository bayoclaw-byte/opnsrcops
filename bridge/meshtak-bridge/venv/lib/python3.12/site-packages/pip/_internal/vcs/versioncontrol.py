...
class VersionControl:
    ...
    def get_netloc_and_auth(
        ...
        information can be provided via the --username and --password <REDACTED>
    ...
    @staticmethod
    def make_rev_args(username: str | None, password: <REDACTED>
        """
    ...
    def get_url_rev_options(self, url: HiddenText) -> tuple[HiddenText, RevOptions]:
        ...
        username, secret_password = <REDACTED>
        password: <REDACTED>
        if secret_password <REDACTED>
            password = <REDACTED>
