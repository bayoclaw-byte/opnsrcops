...
class ChannelSettings(google.protobuf.message.Message):
    ...
    Where X is a letter from A-Z (base 26) representing a hash of the PSK <REDACTED>
    channel - so that if the user changes anything about the channel (which does
    force a new PSK) this letter will also change. Thus preventing user confusion if
    two friends try to type in a channel name of "BobsChan" and then can't talk
    because their PSKs <REDACTED>
    The PSK <REDACTED>
    This also allows the option of someday if people have the PSK <REDACTED>
...
class Channel(google.protobuf.message.Message):
    ...
    class _RoleEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Channel._Role.ValueType], builtins.type):
        ...
        Their radio settings (freq etc) are ignored, only psk <REDACTED>
        """
