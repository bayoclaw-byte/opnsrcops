...
class User(google.protobuf.message.Message):
    ...
    This is sent out to other nodes on the mesh to allow them to compute a shared secret <REDACTED>
    """
...
class LockdownStatus(google.protobuf.message.Message):
    ...
    For LOCKED: machine-readable reason. Known values:
      ...
      "token_missing"     — no boot token <REDACTED>
      "token_expired"     — boot token <REDACTED>
      "token_boots_zero"  — boot token <REDACTED>
      "token_hmac_fail"   — token <REDACTED>
      "token_dek_fail"    — token <REDACTED>
      "token_wrong_size"  — token <REDACTED>
      "token_bad_magic"   — token <REDACTED>
