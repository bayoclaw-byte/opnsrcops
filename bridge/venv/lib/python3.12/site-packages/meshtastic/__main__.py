...
def setPref(config, comp_name, raw_val) -> bool:
    ...
    if snake_name == "wifi_psk" and len(str(raw_val)) < 8:
        print("Warning: network.wifi_psk <REDACTED>
        return False
...
def addChannelConfigArgs(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    group.add_argument(
        ...
        help=(
            ...
            "Can set the 'psk' using this command. To disable encryption on primary channel:'--ch-set psk <REDACTED>
            "To set encryption with a new random key on second channel:'--ch-set psk <REDACTED>
            "To set encryption back to the default:'--ch-set psk <REDACTED>
            "own key: '--ch-set psk <REDACTED>
        ),
        nargs=2,
        action="append",
        metavar=("FIELD", "VALUE"),
