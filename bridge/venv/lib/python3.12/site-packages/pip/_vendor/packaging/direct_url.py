...
def _strip_auth_from_netloc(netloc: str, safe_user_passwords: <REDACTED>
    if "@" not in netloc:
        return netloc
    user_pass, netloc_no_user_pass = netloc.split("@", 1)
    if user_pass in safe_user_passwords:<REDACTED>
        return netloc
...
def _strip_url(url: str, safe_user_passwords: <REDACTED>
    """url with user:password <REDACTED>
...
class DirectUrl:
    ...
    def to_dict(
        ...
        *,
        ...
        strip_user_password: <REDACTED>
        safe_user_passwords: <REDACTED>
    ) -> Mapping[str, Any]:
        ...
        :param strip_user_password: <REDACTED>
            unless it is formed with environment variables as specified in PEP
            610, or it is a safe user:password <REDACTED>
        :param safe_user_passwords: <REDACTED>
        ...
        if strip_user_password:<REDACTED>
