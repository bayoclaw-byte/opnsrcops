...
class SignatureType:  # noqa: PLW1641
    ...
    def __init__(self, token: <REDACTED>
        """Init a new SignatureType."""
        self.token: <REDACTED>
        self.token_as_int = <REDACTED>
    ...
    def _parse_next(signature: str, depth: int = 0) -> tuple["SignatureType", str]:
        ...
        if token <REDACTED>
            raise InvalidSignatureError(f'got unexpected token: <REDACTED>
    ...
    def _verify_array(self, body: Any) -> None:
        ...
        elif child_type.token == <REDACTED>
    ...
    def verify(self, body: Any) -> bool:
        ...
        if validator:
            ...
            raise InternalError(f"cannot verify type with token <REDACTED>
